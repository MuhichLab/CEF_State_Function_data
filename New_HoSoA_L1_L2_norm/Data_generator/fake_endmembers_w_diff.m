function [fake_end_terms] = fake_endmembers_w_diff(gs,end_terms,T0)
    ...
    [~,~,~,coeffs1,S01,diffH1] = fit_einstein(700,gs_j(1),T0,5,plotme);
    [~,~,~,coeffs2,S02,diffH2] = fit_einstein(600,gs_j(2),T0,5,plotme);
    [~,~,~,coeffs3,S03,diffH3] = fit_einstein(450,gs_j(5),T0,4.5,plotme);
    [~,~,~,coeffs4,S04,diffH4] = fit_einstein(500,gs_j(6),T0,4.5,plotme);
